...
private:
  ...
  juce::GroupComponent controllers_group_{};
  juce::Label autohide_explain_label_{};
  juce::Label pickup_label_{"PickupLabel", ""};
  juce::Label profile_location_label_{"Profile Label"};
  juce::Label continuous_label_{"ContinuousLabel", ""};
  juce::Label maxpitch_label_{"MaxPitchLabel", ""};
  ...
  juce::ToggleButton continuous_enabled_{"Continuous Encoder Mode"};
  juce::TextEditor pitch_max_value_;
