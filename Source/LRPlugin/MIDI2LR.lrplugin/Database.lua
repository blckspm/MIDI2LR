...
local DataBase = {
  ...
  {"DefringePurpleHueLo",'lensCorrectionsPanel',true,true,true,false,false,LOC("$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/PurpleDefringeHueLo=Defringe Purple Hue")..' - '..LOC("$$$/Slideshow/Panels/PanAndZoom/Low=Low"),lensCorrections,"",'lensCorrectionsPanel'},
  {"DefringePurpleHueHi",'lensCorrectionsPanel',true,true,true,false,false,LOC("$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/PurpleDefringeHueLo=Defringe Purple Hue")..' - '..LOC("$$$/Slideshow/Panels/PanAndZoom/High=High"),lensCorrections,"",'lensCorrectionsPanel'},
  ...
  {"DefringeGreenHueLo",'lensCorrectionsPanel',true,true,true,false,false,LOC("$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/GreenDefringeHueLo=Defringe Green Hue")..' - '..LOC("$$$/Slideshow/Panels/PanAndZoom/Low=Low"),lensCorrections,"",'lensCorrectionsPanel'},
  {"DefringeGreenHueHi",'lensCorrectionsPanel',true,true,true,false,false,LOC("$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/GreenDefringeHueLo=Defringe Green Hue")..' - '..LOC("$$$/Slideshow/Panels/PanAndZoom/High=High"),lensCorrections,"",'lensCorrectionsPanel'},
  ...
  {"PerspectiveVertical",'lensCorrectionsPanel',true,true,true,false,false,LOC("$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/PerspectiveVertical=Perspective Vertical"),lensCorrections,"Corrects perspective caused by tilting the camera up or down. Makes vertical lines appear parallel. Note that perspective horizontal and vertical are oriented as if the camera were in landscape orientation. When adjusting a picture in portrait orientation, 'horizontal' alters vertical lines and 'vertical' alters horizontal lines.",'lensCorrectionsPanel'},
  {"PerspectiveHorizontal",'lensCorrectionsPanel',true,true,true,false,false,LOC("$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/PerspectiveHorizontal=Perspective Horizontal"),lensCorrections,"Corrects perspective caused by angling the camera left or right. Makes horizontal lines parallel. Note that perspective horizontal and vertical are oriented as if the camera were in landscape orientation. When adjusting a picture in portrait orientation, 'horizontal' alters vertical lines and 'vertical' alters horizontal lines.",'lensCorrectionsPanel'},
